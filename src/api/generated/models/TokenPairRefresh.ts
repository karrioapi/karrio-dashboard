 ...
 * 
 * @export
 * @interface TokenPairRefresh
 */
export interface TokenPairRefresh {
    /**
     * 
     * @type {string}
     * @memberof TokenPairRefresh
     */
    refresh: string;
    /**
     * 
...
export function TokenPairRefreshFromJSON(json: any): TokenPairRefresh {
    return TokenPairRefreshFromJSONTyped(json, false);
}

export function TokenPairRefreshFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokenPairRefresh {
...
export function TokenPairRefreshToJSON(value?: TokenPairRefresh | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
