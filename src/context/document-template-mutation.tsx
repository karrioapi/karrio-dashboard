...
export type DocumentTemplateInput = (CreateDocumentTemplateInput | UpdateDocumentTemplateInput) & {
  id?: string;
  label: string;
  is_default: boolean;
...
type TemplateMutator = {
  createDocumentTemplate: (data: CreateDocumentTemplateInput) => Promise<create_document_template_create_document_template | null>;
  updateDocumentTemplate: (data: UpdateDocumentTemplateInput) => Promise<update_document_template_update_document_template | null>;
...
const DocumentTemplateMutationProvider: React.FC<{}> = ({ children }) => {
  ...
  const createDocumentTemplate = (data: CreateDocumentTemplateInput) => (
    handleGraphQLRequest("create_document_template", createMutation)({ variables: { data } })
  );
  const updateDocumentTemplate = (data: UpdateDocumentTemplateInput) => (
