...
import { get_order, GET_ORDER, get_orderVariables, get_order_order } from 'karrio/graphql';
...
const OrderProvider: React.FC = ({ children }) => {
  ...
  const loadOrder = (id: string) => (result.called ? result.fetchMore : load)({ variables: { id } });
