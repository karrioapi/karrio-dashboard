...
export class V1Api extends runtime.BaseAPI {
    ...
    /**
     */
    async v1BillingSubscriptionListRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async v1BillingSubscriptionList(initOverrides?: RequestInit): Promise<void> {
        await this.v1BillingSubscriptionListRaw(initOverrides);
    }
