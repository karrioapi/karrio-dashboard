...
export class AddressesApi extends runtime.BaseAPI {
     ...
     * Discard an address
     */
    async discardRaw(requestParameters: DiscardRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Address>> {
     ...
     * Discard an address
     */
    async discard(requestParameters: DiscardRequest, initOverrides?: RequestInit): Promise<Address> {
