...
export class AddressesApi extends runtime.BaseAPI {
     ...
     * List all addresses
     */
    async listRaw(requestParameters: ListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddressList>> {
        const queryParameters: any = {};
     ...
     * List all addresses
     */
    async list(requestParameters: ListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AddressList> {
