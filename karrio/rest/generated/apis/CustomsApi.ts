...
export class CustomsApi extends runtime.BaseAPI {
     ...
     */
    async listRaw(requestParameters: ListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CustomsList>> {
        const queryParameters: any = {};
     ...
     * List all customs info
     */
    async list(requestParameters: ListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CustomsList> {
