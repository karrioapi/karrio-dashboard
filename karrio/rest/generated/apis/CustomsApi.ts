...
export class CustomsApi extends runtime.BaseAPI {
     ...
     */
    async discardRaw(requestParameters: DiscardRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Customs>> {
     ...
     * Discard a customs info
     */
    async discard(requestParameters: DiscardRequest, initOverrides?: RequestInit): Promise<Customs> {
