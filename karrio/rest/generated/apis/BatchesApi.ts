...
export class BatchesApi extends runtime.BaseAPI {
     ...
     */
    async listRaw(requestParameters: ListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BatchOperations>> {
     ...
     * List all batch operations
     */
    async list(requestParameters: ListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BatchOperations> {
