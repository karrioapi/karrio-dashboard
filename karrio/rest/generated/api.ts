...
export const DocumentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        list: async (dateAfter?: string, dateBefore?: string, shipmentId?: string, limit?: number, offset?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DocumentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async list(dateAfter?: string, dateBefore?: string, shipmentId?: string, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DocumentUploadRecords>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(dateAfter, dateBefore, shipmentId, limit, offset, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a shipping document upload record.
...
export const DocumentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        list(dateAfter?: string, dateBefore?: string, shipmentId?: string, limit?: number, offset?: number, options?: any): AxiosPromise<DocumentUploadRecords> {
            return localVarFp.list(dateAfter, dateBefore, shipmentId, limit, offset, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a shipping document upload record.
         * @summary Retrieve an upload record
...
export class DocumentsApi extends BaseAPI {
    ...
    public list(requestParameters: DocumentsApiListRequest = {}, options?: AxiosRequestConfig) {
        return DocumentsApiFp(this.configuration).list(requestParameters.dateAfter, requestParameters.dateBefore, requestParameters.shipmentId, requestParameters.limit, requestParameters.offset, options).then((request) => request(this.axios, this.basePath));
    }
