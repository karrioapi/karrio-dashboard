...
/**
 * Check if a given object implements the PickupCancelRequestAddress interface.
 */
export function instanceOfPickupCancelRequestAddress(value: object): boolean {
    let isInstance = true;
...
export function PickupCancelRequestAddressFromJSON(json: any): PickupCancelRequestAddress {
    return PickupCancelRequestAddressFromJSONTyped(json, false);
}

export function PickupCancelRequestAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PickupCancelRequestAddress {
...
export function PickupCancelRequestAddressToJSON(value?: PickupCancelRequestAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
