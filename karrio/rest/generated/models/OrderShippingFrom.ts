...
/**
 * Check if a given object implements the OrderShippingFrom interface.
 */
export function instanceOfOrderShippingFrom(value: object): boolean {
    let isInstance = true;
...
export function OrderShippingFromFromJSON(json: any): OrderShippingFrom {
    return OrderShippingFromFromJSONTyped(json, false);
}

export function OrderShippingFromFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderShippingFrom {
...
export function OrderShippingFromToJSON(value?: OrderShippingFrom | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
