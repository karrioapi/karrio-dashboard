...
/**
 * Check if a given object implements the RateRequestShipper interface.
 */
export function instanceOfRateRequestShipper(value: object): boolean {
    let isInstance = true;
...
export function RateRequestShipperFromJSON(json: any): RateRequestShipper {
    return RateRequestShipperFromJSONTyped(json, false);
}

export function RateRequestShipperFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateRequestShipper {
...
export function RateRequestShipperToJSON(value?: RateRequestShipper | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
