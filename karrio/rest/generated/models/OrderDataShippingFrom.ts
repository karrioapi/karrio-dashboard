...
/**
 * Check if a given object implements the OrderDataShippingFrom interface.
 */
export function instanceOfOrderDataShippingFrom(value: object): boolean {
    let isInstance = true;
...
export function OrderDataShippingFromFromJSON(json: any): OrderDataShippingFrom {
    return OrderDataShippingFromFromJSONTyped(json, false);
}

export function OrderDataShippingFromFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderDataShippingFrom {
...
export function OrderDataShippingFromToJSON(value?: OrderDataShippingFrom | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
