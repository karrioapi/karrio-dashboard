...
/**
 * Check if a given object implements the OrderDataShippingTo interface.
 */
export function instanceOfOrderDataShippingTo(value: object): boolean {
    let isInstance = true;
...
export function OrderDataShippingToFromJSON(json: any): OrderDataShippingTo {
    return OrderDataShippingToFromJSONTyped(json, false);
}

export function OrderDataShippingToFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderDataShippingTo {
...
export function OrderDataShippingToToJSON(value?: OrderDataShippingTo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
