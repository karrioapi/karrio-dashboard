...
/**
 * Check if a given object implements the PickupAddress interface.
 */
export function instanceOfPickupAddress(value: object): boolean {
    let isInstance = true;
...
export function PickupAddressFromJSON(json: any): PickupAddress {
    return PickupAddressFromJSONTyped(json, false);
}

export function PickupAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PickupAddress {
...
export function PickupAddressToJSON(value?: PickupAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
