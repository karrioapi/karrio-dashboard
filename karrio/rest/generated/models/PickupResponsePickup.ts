 ...
 */
export function instanceOfPickupResponsePickup(value: object): boolean {
    let isInstance = true;
...
export function PickupResponsePickupFromJSON(json: any): PickupResponsePickup {
    return PickupResponsePickupFromJSONTyped(json, false);
}

export function PickupResponsePickupFromJSONTyped(json: any, ignoreDiscriminator: boolean): PickupResponsePickup {
...
export function PickupResponsePickupToJSON(value?: PickupResponsePickup | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
