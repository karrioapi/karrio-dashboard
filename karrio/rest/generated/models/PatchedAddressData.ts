...
/**
 * Check if a given object implements the PatchedAddressData interface.
 */
export function instanceOfPatchedAddressData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PatchedAddressDataFromJSON(json: any): PatchedAddressData {
    return PatchedAddressDataFromJSONTyped(json, false);
}

export function PatchedAddressDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedAddressData {
    ...
    return {
        ...
        'country_code': !exists(json, 'country_code') ? undefined : CountryEnumFromJSON(json['country_code']),
...
export function PatchedAddressDataToJSON(value?: PatchedAddressData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
