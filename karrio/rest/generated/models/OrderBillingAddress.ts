...
/**
 * Check if a given object implements the OrderBillingAddress interface.
 */
export function instanceOfOrderBillingAddress(value: object): boolean {
    let isInstance = true;
...
export function OrderBillingAddressFromJSON(json: any): OrderBillingAddress {
    return OrderBillingAddressFromJSONTyped(json, false);
}

export function OrderBillingAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderBillingAddress {
...
export function OrderBillingAddressToJSON(value?: OrderBillingAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
